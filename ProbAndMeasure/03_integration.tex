...
\begin{theorem}[Differentiation Under The Integral Sign]
	...
	Let $f \colon U \times E \to \mathbb R$ be a s.t.
	\begin{enumerate}
...
\begin{example}[Integrals and Image Measures.]
	...
	On a probability space $(\Omega, \mathcal F, \mathbb P)$ and $X \geq 0$ measurable, we have,
	\[ \expect{g(X)} = \int_\Omega g(X(\omega)) \dd{\mathbb P(\omega)} = \int_\Omega g \dd{\mu_X}, \]
