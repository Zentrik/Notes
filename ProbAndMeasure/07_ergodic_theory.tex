...
The point is an ergodic tranformation mixes the sets well.
Boltzman (1880), Ergodic hypothesis - over long times, a gas particle in some space will ``fill the whole space'', it will be arbitrarly close to any point in the space.
