...
\begin{definition}[Ring Homomorphism]
	...
	A function $\varphi \colon R \to S$ is a \vocab{ring homomorphism} if
	\begin{enumerate}
...
\begin{lemma} \label{lem:8.1}
	Let $R, S$ be rings.
	Then a ring homomorphism $\varphi \colon R \to S$ is injective iff $\ker \varphi = \qty{0}$.
\end{lemma}
...
\begin{proof}
	Considering the induced group homomorphism on addition, $\varphi \colon (R, +) \to (S, +)$, $\ker \phi$ is a subgroup of $(R, +)$.
