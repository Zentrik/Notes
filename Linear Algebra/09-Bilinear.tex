...
\begin{definition}[Congruence]
	...
	We say that $A, B$ are \vocab{congruent} if there exists $P \in M_n(F)$ such that $A = P^\transpose B P$.
\end{definition}
...
\begin{definition}[Symmetric]
	A bilinear form $\phi$ on $V$ is \vocab{symmetric} if, for all $u, v \in V$, we have
	\begin{align*}
		\phi(u,v) = \phi(v,u)
	\end{align*}
\end{definition}
...
\begin{definition}[Quadratic Form]
	A map $Q \colon V \to F$ is a \vocab{quadratic form} if there exists a bilinear form $\phi \colon V \times V \to F$ such that, for all $u \in V$,
	\begin{align*}
		Q(u) = \phi(u,u)
	\end{align*}
\end{definition}
...
\begin{proof}
	...
	This identity for $\phi(u,v)$ is known as the \vocab{polarisation identity}.
\end{proof}
...
\begin{definition}[Signature]
	Let $F = \mathbb R$.
	The \vocab{signature} of a bilinear form $\phi$ is
	\begin{align*}
		s(\phi) = p - q
	\end{align*}
...
\begin{definition}[Positive Definite]
	...
	We say that
	\begin{enumerate}
		\item $\phi$ is \vocab{positive definite} if $\phi(u,u) > 0$ for all nonzero $u \in V$;
		\item $\phi$ is \vocab{positive semidefinite} if $\phi(u,u) \geq 0$ for all $u \in V$;
		\item $\phi$ is \vocab{negative definite} or \vocab{negative semidefinite} if $\phi(u,u) < 0$ or $\phi(u,u) \leq 0$ respectively for all nonzero $u \in V$.
	\end{enumerate}
\end{definition}
...
\begin{definition}[Kernel]
	...
	This is the \vocab{kernel} of the bilinear form.
\end{definition}
\begin{remark}
...
\begin{definition}[Sesquilinear Form]
	...
	A form $\phi \colon V \times W \to \mathbb C$ is called \vocab{sesquilinear} if it is linear in the first entry, and
	\begin{align*}
...
\begin{definition}[Hermitian Forms]
	Let $V$ be a finite-dimensional $\mathbb C$-vector space.
	Let $\phi$ be a sesquilinear form on $V$.
	Then $\phi$ is \vocab{Hermitian} if, for all $u, v \in V$,
	\begin{align*}
		\phi(u, v) = \overline{\phi(v,u)}
	\end{align*}
\end{definition}

This is the complex value generalisation of symmetric bilinear form.
...
\begin{theorem}[Sylvester's law of inertia for Hermitian forms]
	Let $V$ be a finite-dimensional $\mathbb C$-vector space.
...
\begin{definition}[Skew-symmetric Form]
	Let $V$ be a finite-dimensional $\mathbb R$-vector space.
	Let $\phi$ be a bilinear form on $V$.
	Then $\phi$ is \vocab{skew-symmetric} if, for all $u,v \in V$,
	\begin{align*}
		\phi(u,v) = -\phi(v,u)
	\end{align*}
\end{definition}
...
\begin{theorem}[Sylvester's law of inertia for Skew-symmetric forms]
	Let $V$ be a finite-dimensional $\mathbb R$-vector space.
