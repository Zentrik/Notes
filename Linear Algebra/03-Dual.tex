...
\begin{definition}[Dual Space]
	...
	If $\alpha \colon V \to F$ is linear, then we say $\alpha$ is a \vocab{linear form}.
...
\begin{definition}[Double Dual]
	...
	The \vocab{double dual} or \vocab{bidual} of $V$ is
	\begin{align*}
...
\begin{remark}
	...
	\begin{enumerate}
		...
		These are called \vocab{reflexive spaces}.
		\begin{example}
		...
		\item There is a \vocab{canonical embedding} from $V$ to $V^\sstar$.
