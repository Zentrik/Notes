...
\underline{Aim}: We wan to show that there is in fact only ONE (up to a multiplicative constant) volume form on $F^n \times \dots \times F^n$ which is given by the determinant.
