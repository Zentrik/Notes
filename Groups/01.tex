...
\begin{example} \protect\hypertarget{exm:nine}{}\label{exm:nine}
...
\begin{example}~
\vspace*{-1.5\baselineskip} % ~ adds 1 \baslineskip I think and exm has 0.5 at beginning
  \begin{align*}
