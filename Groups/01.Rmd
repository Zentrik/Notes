...
iii. Let $G$ be a group and $g_1, \ldots, g_k \in G$. Then the subgroup of $G$ generated by $g_1, \ldots, g_k$ denoted $\left\langle g_1, \ldots, g_k \right\rangle$ is the smallest subgroup of $G$ containing all the $g_i$'s. It is the intersection of all the subgroups of $G$ containing all the $g_i$'s.
:::