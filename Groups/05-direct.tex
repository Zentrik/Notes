...
\begin{proof}
  ...
  So $(a \langle b \rangle)^2 = a^2 \langle b \rangle = e = \langle b \rangle$ by \Cref{cor:two}.
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item If all non-identity elements have order 2, then $G$ is abelian (Sheet 1, Q8). Let $a\not= b\in G\setminus\{e\}$. By the direct product theorem, $\langle a, b\rangle = \langle a\rangle\times\langle b\rangle$. Then take $c\not\in \langle a, b\rangle$. By the direct product theorem, we obtain $\langle a, b, c\rangle = \langle a\rangle\times\langle b\rangle\times\langle c\rangle = C_2\times C_2\times C_2$. Since $\langle a, b, c\rangle\subseteq G$ and $|\langle a, b, c\rangle| = |G|$, $G = \langle a, b, c\rangle \cong C_2\times C_2\times C_2$.
    \item $G$ has no element of order 8 but has an order 4 element $a\in G$. Let $H = \langle a\rangle$. Since $H$ has index 2, it is normal in $G$. So $G/H \cong C_2$ since $|G/H| = 2$. This means that for any $b\not\in H$, $bH$ generates $G/H$. Then $(bH)^2 = b^2H = H$. So $b^2\in H$. Since $b^2\in \langle a\rangle$ and $\langle a\rangle$ is a cyclic group, $b^2$ commutes with $a$.
      ...
      \begin{itemize}
        \item When $l\equiv 1\pmod 4$, $bab^{-1} = a$, i.e.\ $ba = ab$. So $G$ is abelian.
          \begin{itemize}
            \item If $b^2 = e$, then $G = \langle a, b\rangle \cong \langle a\rangle \times \langle b\rangle \cong C_4\times C_2$.
...
\begin{proof}
  If $|G| = 8$
  Let $1 \neq g \in G \implies o(g) = 2, 4 \text{ or } 8$ by \Cref{cor:two}.
  ...
  \begin{align*}
    ...
    &\cong \langle a, b \rangle \times \langle c \rangle \\
    &\cong \langle a \rangle \times \langle b \rangle \times \langle c \rangle \\
    &\cong C_2 \times C_2 \times C_2
  \end{align*} 

  Now suppose $\exists \; g \in G, o(g) > 2 \implies \exists \; a \in G, o(a) = 4$ (if we have $o(a) = 8$, then $o(a^2) = 4$). 
  ...
  \begin{align*}
    ...
    \\
    \text{If } bab^{-1} &= a \implies ba = ab \\
    \implies G &= \langle a \rangle \cup b \langle a \rangle \text{ is abelian}. \\
    \\
    \text{If } b^2 &= e \\
    \implies G &= \langle a \rangle \cup \langle a \rangle b \\
    &= \langle a \rangle \langle b \rangle \\
    &\cong \langle a \rangle \times \langle b \rangle \\
    &\cong C_4 \times C_2. \\
    \\
    \text{If } b^2 &= a^2 \implies (ba^{-1})^2 = e. \\
    \implies G &\cong \langle a \rangle \times \langle ba^{-1} \rangle \\
    &\cong C_4 \times C_2. \\
    \\
    \text{Suppose } bab^{-1} = a^{-1} \\
    \text{If } b^2 = e \implies G &\cong D_8 \ (o(a) = 2, o(b) = 4)
  \end{align*} 
  However if $b^2 = a^2$, we have a new group $Q_8$, quaternion group.
  ...
  Because the abelian that means they are not isomorphic?
