...
\begin{example} \label{exm:actions} ~\vspace*{-1.5\baselineskip}
    \begin{enumerate} \def\labelenumi{\roman{enumi}.} \def\labelenumii{\arabic{enumii}.} 
        ...
        {\centering
        \includegraphics[height=5cm]{06-square-action}
        \par}
        \begin{align*}
            t(a) &= c & t(c) &= a \\
            t(b) &= b & t(d) &= d. \\
        ...
        {\par \centering \includegraphics[height=5cm]{06-square-action-vertex} \par}
        \begin{align*}
            t(1) &= 4 & t(4) &= 1 \\
            t(2) &= 3 & t(d) &= 2.
        \end{align*} 
...
\begin{example}
The kernels of \Cref{exm:actions}
    \begin{enumerate}
...
\begin{figure}
    \centering 
    \includegraphics[height=5cm]{07-tetrahedron}
...
\begin{figure}
    \centering 
    \includegraphics[height=5cm]{07-tetrahedron-rotations} 
...
\begin{figure} 
    \centering 
    \includegraphics[height=5cm]{07-tetrahedron-double-transposition} 
...
\begin{itemize}
    ...
    \begin{figure} 
        \centering 
        \includegraphics[height=5cm]{07-tetrahedron-12-fixed} 
...
\begin{figure}
    \centering 
    \includegraphics[height=5cm]{07-cube} 
\end{figure}
...
\begin{itemize}
    ...
    \item \begin{figure} 
        \centering 
        \includegraphics[height=5cm]{04-cube-rotated}
    ...
    \item \begin{figure}
        \centering 
        \includegraphics[height=5cm]{07-cube-rotated-fixed-axis} 
    ...
    \item \begin{figure} 
        \centering 
        \includegraphics[height=5cm]{07-cube-transpositions}
...
\begin{figure}
    \centering
    \includegraphics[height=5cm]{07-cube-dodecahedron}
\end{figure} 
...
\begin{proof}
    ...
    But by \nameref{thm:three} $|N| \mathbin{\bigg|} |A_5| = 60 \implies |N| = 1 \text{ or } 60$.
\end{proof} 
