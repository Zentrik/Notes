...
i. There exists a basis of eigenvectors for $V$, $\underline{v}_1, \underline{v}_2, \dots, \underline{v}_n$ with $A \underline{v}_i = \lambda_i \underline{v}_i$ (not $\sum_i$ and $\lambda_i$ need not be distinct).
...
```{r 06-quadratic-R2-1, echo = FALSE, fig.cap = "", fig.align="center", out.height="300"} 
...
```{r 06-quadratic-R2-2, echo = FALSE, fig.cap = "", fig.align="center", out.height="300"} 
...
```{r 06-hyperboloid-1, echo = FALSE, fig.cap = "", fig.align="center", out.height="300"} 
knitr::include_graphics("figures/06-hyperboloid-1.png") 
```

$\mathcal{F} = -1 \iff x_1'^2 + x_2'^2 = 1 + 2 x_3'^2$ defined a hyperboloid (2 sheeted).

```{r 06-hyperboloid-2, echo = FALSE, fig.cap = "", fig.align="center", out.height="300"} 
