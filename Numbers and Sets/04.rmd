...
Hence the no. of subsets of $\{1, 2, \dots, n\}$ 
\begin{align*}
    \{1, 2, \dots, n\} &= 2 \times \text{ no. of subsets of } \{1, 2, \dots, n - 1\} \\
    &= 2 \cdot 2^{n - 1} \\
    &= 2^n.
\end{align*} 
:::
...
Each subset of size $k$ if picked in $k (k - 1) (k - 2) \dots 2 \cdot 1$ ways by this method.
...
Then \begin{align*}
    ...
    \text{Equivalently } \left | \bigcap{i = 1}^n S_i \right| &= \sum_{k=1}^{n} (-1)^{k + 1} \sum_{A \subseteq \{1, 2, \dots, n\}, |A| = k} \left | \bigcap_{i \in A} S_i \right |.
\end{align*}
:::
...
This equivalence relations partitions $\mathbb{Z}$ into "pieces" consisting of related elements, namely $\{x \in \mathbb{Z} : x \equiv 0 \mod 5\}, \{x \in \mathbb{Z} : x \equiv 1 \mod 5\}, \dots, \{x \in \mathbb{Z} : x \equiv 4 \mod 5\}$.
...
E.g. $[(1, 2)] = \{(1, 2), (2, 4), (3, 6) \dots \}$ so we can regard $\mathbb{Z} \times \mathbb{N} / R$ as a copy of $Q$ by identifying $[(a, b)]$ with $\frac{a}{b} \in \mathbb{Q}$.
