...
It is easy to see that $B$ is an equivalence relation. \\
E.g. $[(1, 2)] = \{(1, 2), (2, 4), (3, 6) \ldots \}$ so we can regard $\mathbb{Z} \times \mathbb{N} / R$ as a copy of $Q$ by identifying $[(a, b)]$ with $\frac{a}{b} \in \mathbb{Q}$.
