...
\begin{align*}
    s_{2^k - 1} &= 1 + \underbrace{\frac{1}{2^2} + \frac{1}{3^2}}_{\leq 2 \cdot \frac{1}{2^2}} + \underbrace{\frac{1}{4^2} + \frac{1}{5^2} + \frac{1}{6^2} + \frac{1}{7^2}}_{\leq 4 \frac{\cdot_1}{4}^2} + \dots + \frac{1}{(2^k - 1)^2} \\
...
\begin{align*}
    ...
    &= (x - y) [a_d (x^{d- 1} + x^{d-2} y + \dots + y^{d-1}) + \dots + \dots a_1] \\
...
```
\begin{align*}
    \text{Note } |L - L_n| = \sum_{k=n + 1}^{\infty} \frac{1}{10^{k!}} &\leq \frac{1}{10^{(n + 1)!}} (1 + \frac{1}{2} + \frac{1}{2}^2 \dots) \\
    &= \frac{2}{10^{(n + 1)!}}
\end{align*} 
