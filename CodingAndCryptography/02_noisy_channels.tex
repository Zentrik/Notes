...
\begin{example}
    A \vocab{simple parity check code} or \vocab{paper tape code} of length $n$ identifies the set $\qty{0,1}$ with the field $\mathbb F_2$ of two elements, and defines $C = \qty{(x_1, \dots, x_n) \in \mathbb F_2^n : \sum x_i = 0}$.
