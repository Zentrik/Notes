...
\end{tikzpicture}\footnote{This graphic doesn't seem to render properly in edge.}

The support needs to be a rectangle as then the indicator function will split as a product.
